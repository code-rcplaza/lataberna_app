...
<template>
  ...
  <div v-else class="space-y-8">
    ...
    <div v-if="character.backgroundType" class="bg-surface-container-low p-5 space-y-3">
      ...
      <div v-if="character.backgroundDescription" class="flex flex-col gap-1 pt-1">
        <span class="text-[10px] font-bold uppercase tracking-widest text-secondary">Descripción de la dote</span>
        <span class="font-body text-on-surface text-sm">{{ character.backgroundDescription }}</span>
      </div>
    </div>
